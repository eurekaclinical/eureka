	...
	<template:content name="content">
		<div class="content">
			...
			<div class="pad pad_btm">
				<p>
					<h4 class="large pad_top">Center for Comprehensive Informatics

					</h4>
					<p>
						<strong>Emory University</strong><br /> Psychology Building,
						Suite 566<br /> 36 Eagle Row<br /> Atlanta, GA, 30322
					</p>
