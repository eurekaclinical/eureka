...
(function($){
    $.fn.smartWizard = function(action) {
        ...
        return this.each(function(){
                ...
                var steps = $("ul#steps > li > a", obj); // Get all anchors in this array
                var contentWidth = 0;
                ...
                msgBox = $('.msgBox',obj);
                if(msgBox.length == 0){
                  msgBox = $('<div class="msgBox"><div class="msg_content"></div><a href="#" class="close">X</a></div>');
