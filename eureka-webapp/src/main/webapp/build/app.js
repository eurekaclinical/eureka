...
(function () {
     ...
     * @requires register
     */
    angular.module('eureka', ['ui.router', 'ui.tree', 'angularValidator', 'ngMaterial', 'md.data.table', 'eureka.cohorts', 'eureka.phenotypes', 'eureka.register', 'eureka.account']);
...
(function () {
  ...
  function accountConfig($stateProvider) {
    $stateProvider.state('accountAdministration', {
...
(function () {
    ...
    function users($http, $q, appProperties) {
        ...
        function getUsers() {
            return $http.get(apiEndpoint + '/users').then(handleSuccess, handleError);
        }
...
(function () {
    ...
    angular.module('eureka.account').factory('AccountService', AccountService);
    ...
    function AccountService($http, $q, appProperties) {
        ...
        function changePassword(passwordObject) {
            return $http.post(apiEndpoint + '/users/passwordchangerequest', passwordObject).then(handleSuccess, handleError);
        }

        function getUserById(id) {
            return $http.get(apiEndpoint + '/users/byid/' + id).then(handleSuccess, handleError);
        }

        function updateUser(userObject) {
            return $http.put(apiEndpoint + '/users/', userObject).then(handleSuccess, handleError);
        }
...
(function () {
    ...
    angular.module('eureka.register').factory('RegisterService', RegisterService);
...
(function () {
    ...
    angular.module('eureka.account').controller('account.administration.EditCtrl', EditCtrl);
...
(function () {
    ...
    angular.module('eureka.account').controller('account.administration.MainCtrl', MainCtrl);
...
(function () {
    ...
    angular.module('eureka.account').controller('account.settings.MainCtrl', MainCtrl);
