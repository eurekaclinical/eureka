...
(function () {
     ...
     * @requires register
     */
    angular.module('eureka', ['ui.router', 'ui.tree', 'angularValidator', 'ngMaterial', 'eureka.cohorts', 'eureka.phenotypes', 'eureka.register']);
    ...
    function CohortService($http, $q) {
        ...
        function createCohort(cohort) {
            ...
            */
            ...
            var cohortTemplateObj = { 'id': null, 'type': 'COHORT', 'ownerUserId': 1,
            ...
            return $http.post('/eureka-webapp/proxy-resource/destinations/', cohortTemplateObj).then(handleSuccess, handleError);
        }
