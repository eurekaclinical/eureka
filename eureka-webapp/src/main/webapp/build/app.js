...
(function () {
     ...
     * @requires register
     */
    angular.module('eureka', ['ngMessages', 'ui.router', 'ui.tree', 'angularValidator', 'ngMaterial', 'md.data.table', 'eureka.cohorts', 'eureka.phenotypes', 'eureka.register']);
