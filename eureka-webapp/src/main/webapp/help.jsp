...
<template:insert template="/templates/eureka_main.jsp">
	...
	<template:content name="content">
		<div class="content">
			...
			<p>
				<strong>Troubleshooting</strong><br /> The Administration tab
				exists to provide some measure of control to restart components of
				the workflow that are not functioning normally. Behind the scenes,
				the workflow uses JBoss to host i2b2 and a web services interface to
				the workflow, and it uses Oracle-XE 11g to host your uploaded data
				once it is loaded into i2b2. The Administration tab contains two
				boxes for restarting the Webservice (includes i2b2) and Oracle
				instances. For each box, click the restart button in the lower right
				corner. Depending on the capabilities of your computer, restarting
				either service may take some time.
			</p>
			<p>
				<strong>Feedback and Bug Reports</strong><br /> As this is a
				technology preview, it is possible that something will go wrong.
				Please contact the developer team with feedback and issues. <a
					href="mailto:admin@emory.edu">admin@emory.edu</a>
			</p>
		</div>
	</template:content>
