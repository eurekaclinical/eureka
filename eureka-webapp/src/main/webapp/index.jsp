...
<template:insert template="/templates/eureka_main.jsp">
	...
	<template:content name="content">
      ...
      <p style="font-size:11px;">To get started, click on the Register link. You will soon receive an account and can begin uploading data. Click on the Help link to learn more.</p>
        ...
        <p style="font-size:11px;">The website's software is available as open source under the Apache 2 license. To deploy this software at your own institution, see our <a href="${initParam['aiw-site-url']}" target="_blank">Sourceforge site</a>. Alternatively, a pre-installed version of this software is available in the <a href="http://aws.amazon.com/" target="_blank" rel="nofollow">Amazon EC2</a> for cloud deployment (search for "EurekaCVRG" under Community AMIs). Source code and developer documentation are available from the <a href="${initParam['eureka-dev-site-url']}" target="_blank">Eureka! Clinical Analytics Developer Resources</a> page.</p>
