...
<template:insert template="/templates/eureka_main.jsp">
	...
	<template:content name="subcontent">
		...
		<div class="release_notes sub_width">
			<p>11.11.2013: Version 1.8 is out! This version provides the ability to directly connect to a database as a data source, in addition to uploading a spreadsheet.  The phenotype editor UI has also been improved.</p>
