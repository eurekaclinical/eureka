...
<template:insert template="/templates/eureka_main.jsp">
	...
	<template:content name="content">
      ...
      <p style="font-size:11px;">To get started, click on the Register link. You will soon receive an   account and can begin uploading data. Click on the Help link to learn   more.</p>
        ...
        <p style="font-size:11px;">The website's source code is available as open source under the Apache 2 license. Source code and developer documentation are available from the <a href="${initParam['eureka-dev-site-url']}" target="_blank">Eureka! Clinical Analytics Developer Resources</a> page.</p>
