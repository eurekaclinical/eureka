...
public class EurekaDataSourceBackend extends RelationalDbDataSourceBackend {
		...
		EntitySpec[] constantSpecs = new EntitySpec[]{
				...
				new EntitySpec("Patient Details", null, new String[]{"Patient"},
						...
						new ReferenceSpec[]{
								...
								new ReferenceSpec("enrollmentStart",
										"EnrollmentStart", new ColumnSpec[]{
										new ColumnSpec(schemaName, "PATIENT",
										...
										ReferenceSpec.Type.MANY),
								new ReferenceSpec("enrollmentEnd",
										"EnrollmentEnd", new ColumnSpec[]{
										new ColumnSpec(schemaName, "PATIENT",
												new JoinSpec("PATIENT_KEY",
														"PATIENT_KEY",
														new ColumnSpec
	...
	protected EntitySpec[] eventSpecs() throws IOException {
		...
		EntitySpec[] eventSpecs = new EntitySpec[]{
				new EntitySpec("EnrollmentStart", null,
						new String[]{"EnrollmentStart"}, true,
						new ColumnSpec(getKeyIdSchema(), getKeyIdTable(),
								getKeyIdColumn(), new JoinSpec("PATIENT_KEY",
								"PATIENT_KEY", new ColumnSpec(schemaName,
								"ENROLLMENT"))),
						new ColumnSpec[]{ new ColumnSpec(schemaName,
								"ENROLLMENT", "ENROLLMENT_KEY")},
						new ColumnSpec(schemaName, "ENROLLMENT",
								"TS_START"),
						new ColumnSpec(schemaName,"ENROLLMENT",
								"TS_START"),
						null, null, null, null, null, null, null,
						AbsoluteTimeGranularity.DAY, dtPositionParser,
						null),
				new EntitySpec("EnrollmentEnd", null,
						new String[]{"EnrollmentEnd"}, true,
						new ColumnSpec(getKeyIdSchema(), getKeyIdTable(),
								getKeyIdColumn(), new JoinSpec("PATIENT_KEY",
								"PATIENT_KEY", new ColumnSpec(schemaName,
								"ENROLLMENT"))),
						...
						new ColumnSpec(schemaName, "ENROLLMENT",
								"TS_END"),
						new ColumnSpec(schemaName,"ENROLLMENT", "TS_END"),
						null, null, null, null, null, null, null,
						AbsoluteTimeGranularity.DAY, dtPositionParser,
						null),
										...
										new ColumnSpec(schemaName, "ENCOUNTER",
												new JoinSpec("ENCOUNTER_KEY",
														...
														new ColumnSpec(
																...
																"EVENT_KEY")))},
										ReferenceSpec.Type.MANY),
								new ReferenceSpec("medicationDispenses",
										"Medication Dispenses",	new ColumnSpec[]{
										new ColumnSpec(schemaName,
												"ENCOUNTER", new JoinSpec
												("ENCOUNTER_KEY",
														"ENCOUNTER_KEY",
														new ColumnSpec
																(schemaName,
																		"DISPENSE_EVENT", "EVENT_KEY")))},
										ReferenceSpec.Type.MANY),
				...
				new EntitySpec("Medication Orders", null,
						...
						null),
				new EntitySpec("Medication Dispenses", null,
						this.mapper.readCodes("med_dispense_050113.txt", "\t",
								0), true, new ColumnSpec(getKeyIdSchema(),
						getKeyIdTable(), getKeyIdColumn(),
						new JoinSpec("PATIENT_KEY", "PATIENT_KEY",
								new ColumnSpec(schemaName, "ENCOUNTER",
										new JoinSpec("ENCOUNTER_KEY",
												"ENCOUNTER_KEY", new ColumnSpec
												(schemaName,
														"DISPENSE_EVENT"))))),
						new ColumnSpec[]{
								new ColumnSpec(schemaName, "DISPENSE_EVENT",
										"EVENT_KEY")},
						new ColumnSpec(schemaName, "DISPENSE_EVENT",
								"TS_OBX"), null,
						new PropertySpec[]{}, null, null,
						new ColumnSpec(schemaName, "DISPENSE_EVENT",
								"ENTITY_ID",
								ColumnSpec.Constraint.EQUAL_TO,
								this.mapper
										.propertyNameOrPropIdToSqlCodeArray
												("med_dispense_050113.txt"),
								true), null, null, null,
						AbsoluteTimeGranularity.MINUTE, dtPositionParser,
						null),
		};
		return eventSpecs;
	}
