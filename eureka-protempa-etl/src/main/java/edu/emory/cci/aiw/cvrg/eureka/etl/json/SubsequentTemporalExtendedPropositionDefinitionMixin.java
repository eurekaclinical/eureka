...
public abstract class SubsequentTemporalExtendedPropositionDefinitionMixin {
	@JsonCreator
	public SubsequentTemporalExtendedPropositionDefinitionMixin(
			@JsonProperty("relation") Relation relation,
			@JsonProperty("extendedProposition") TemporalExtendedPropositionDefinition relatedTemporalExtendedPropositionDefinition) {
	}
