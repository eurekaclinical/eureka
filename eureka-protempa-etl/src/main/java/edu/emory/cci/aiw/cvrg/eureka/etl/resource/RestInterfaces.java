...
public class RestInterfaces {
	...
	@Inject
	public RestInterfaces (JobDao jobDao , ConfDao confDao , ProtempaDeviceManager protempaDeviceManager) {
    ...
    public List<Job> getJob (
		...
		JobFilter jobFilter = new JobFilter (_jobId , _userId , status , intervalBegin , intervalEnd);
    ...
    @Path("submitConf")
    @Consumes("application/json")
    public void submitConfiguration (Configuration conf) {
