...
${config.verificationUrl}${user.verificationCode}
...
This step is needed to ensure that your email address is not being misused by a third party. If you did not request an account on Eureka! Clinical Analytics, we apologize for the inconvenience. Please contact ${config.supportEmail} to report the incident, or you may just ignore this message.
